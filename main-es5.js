    ...
    function () {
      ...
      _createClass(HomepageComponent, [{
        ...
        value: function doSearch(e) {
          ...
          this.http.get('https://dataservice.accuweather.com/locations/v1/cities/autocomplete?apikey=1TPRKkt33Ems8fy00UWSEQknQ95m6GtL&q=' + e.term).subscribe(function (response) {
        ...
        value: function doSelect() {
          ...
          var request1 = this.http.get('https://dataservice.accuweather.com/currentconditions/v1/' + this.reducer.autocompleteSearch.id + '?apikey=1TPRKkt33Ems8fy00UWSEQknQ95m6GtL');
          var request2 = this.http.get('https://dataservice.accuweather.com/forecasts/v1/daily/5day/' + this.reducer.autocompleteSearch.id + '?apikey=1TPRKkt33Ems8fy00UWSEQknQ95m6GtL&metric=true');
